return {
  {
    ...
    -- Install in local venv: "uv add jupynium notebook nbclassic jupyter-console"
    -- Or here for global install:
    -- build = "uv pip install . --python=$HOME/.virtualenvs/jupynium/bin/python",
    opts = {
      -- For Conda environment named "jupynium",
      python_host = "python3", -- local project Venv
  ...
  --     if not vim.tbl_contains(opts.sources.default, "jupynium") then
  --       table.insert(opts.sources.default, "jupynium")
  --     end
  --
  --     return opts
  --   end,
